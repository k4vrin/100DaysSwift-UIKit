...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        navigationItem.leftBarButtonItem = UIBarButtonItem(barButtonSystemItem: .compose, target: self, action: #selector(navigate))
    ...
    @objc func navigate() {
        let visualFormatVC = UIStoryboard(name: "Main", bundle: nil).instantiateViewController(withIdentifier: "visual") as! VisualFormatVC
//        self.present(visualFormatVC, animated: true)
        self.navigationController?.pushViewController(visualFormatVC, animated: true)
    }
